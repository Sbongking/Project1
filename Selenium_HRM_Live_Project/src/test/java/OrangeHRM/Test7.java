...
public class Test7 {
  ...
  @Test
  public void F() throws InterruptedException {	  userName.sendKeys("orange");
	  ...
	  Assert.assertTrue(loggedIn.isDisplayed());	
	    wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("menu_pim_viewMyDetails")));	//Navigate to the "My Info" page.
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"menu_pim_viewMyDetails\"]")));
		driver.findElement(By.id("menu_pim_viewMyDetails")).click();
		driver.findElement(By.id("menu_pim_viewMyDetails")).click();	//scroll down the page
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,1000)");
	
	
		driver.findElement(By.linkText("Qualifications")).click();	//add work exp
		driver.findElement(By.id("addWorkExperience")).click();
        driver.findElement(By.id("experience_employer")).sendKeys("IBM");
        driver.findElement(By.id("experience_jobtitle")).sendKeys("Technical Services Specialist");   
        driver.findElement(By.id("experience_from_date")).click();
        driver.findElement(By.id("experience_from_date")).sendKeys("2019-01-03");
        driver.findElement(By.id("experience_from_date")).sendKeys(Keys.ENTER);        
        Thread.sleep(2000);
        driver.findElement(By.id("experience_to_date")).click();
        driver.findElement(By.id("experience_to_date")).sendKeys("2020-10-10");
        driver.findElement(By.id("experience_to_date")).sendKeys(Keys.ENTER);     
        driver.findElement(By.id("experience_comments")).sendKeys("Breaking Codes since ages");      
